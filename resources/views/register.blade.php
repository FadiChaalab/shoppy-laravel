<x-layout>
    <div class="account-pages">
        <div class="accountbg"
            style="background: url('images/bg.jpg');background-size: cover;background-position: center;"></div>
                        ...
                        <div class="card-box shadow-none p-4">
                            <div class="p-2">
                                <div class="text-center mt-4">
                                    <a href="{{url('/register')}}"><img src="{{asset('images/logo-dark.png')}}"
                                            height="22" alt="logo"></a>
                                </div>

                                <h4 class="font-size-18 mt-5 text-center">Free Register</h4>
                                <p class="text-muted text-center">Get your free Shoppy account now.</p>

                                <form class="mt-4" action="{{url('/register_post')}}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group mt-2 mb-0 row">
                                        <div class="col-12 mt-3">
                                            <p class="mb-0">By registering you agree to the Shoppy <a href="#"
